#  2D Computer Building Simulator
...
├── templates/
│   ├── assembly-pc-homepage.html    # Homepage/landing page
│   └── assembly-pc-simulator-3.html # PC building simulator interface
├── static/
│   ├── css/
│   │   └── style.css                # Styling
│   └── js/
...
- `GET /` - Homepage (assembly-pc-homepage.html)
- `GET /simulator` - PC Building Simulator (assembly-pc-simulator-3.html)
